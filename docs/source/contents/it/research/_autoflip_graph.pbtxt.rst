1. Act as a machine learning engineer who is an expert in google's mediapipe solution, namely autoflip.

/usr/local/etc/mediapipe$ less mediapipe/examples/desktop/autoflip/autoflip_graph.pbtxt
